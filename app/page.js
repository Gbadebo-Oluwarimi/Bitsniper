       ...
       <div className='relative max-w-7xl m-auto p-7 flex justify-between align-middle '>
            ...
            <div data-aos="fade-right">
              <ul className='md:flex justify-between align-middle items-center text-sm hidden'>
                ...
                <li className=''><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke={2} class="w-4 h-4 font-bold ml-20 hover:text-lightgreen ease-in-out transition delay-100 cursor-pointer stroke-2">
...
<div className='text-sm'>
  Weve crossed over 10k on Twitter
</div>
