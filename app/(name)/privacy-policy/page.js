                  ...
                  <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white px-2">BitSniper.io</span>
                            ...
                            <div className='items-center align-middle text-center'>xf</div>
                              ...
                              <div className='pt-7'>
                                  ...
                                  Who we are?
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>Bitsniper Kft is a not for profit organisation based in Budapest, Hungary that is dedicated to act as an objective, supervisory and educational body for the Game-Fi protocol and its associated ecosystem. The registered address is:  Northside Business Centre, váci út 91, 1139, Buda Hungary. We work in close cooperation with our partners
                              </div>
                              <div className='pt-7'>
                                  <div className='text-2xl text-white inline-block'>
                                  How we collect information about you:
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>We obtain information about you when you use our website, when you contact us via email or a web form or if you register to receive one of our regular newsletters. We may collect and process the following types of information about you:
                              </div>
                              <div className='pt-7'>
                                  <div className='text-2xl text-white inline-block'>
                                  Information you provide us
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>You may provide us with personal information by filling in forms on our website(s) or by corresponding with us by e-mail or live-chat. The personal information you provide may include your name, email, address, phone number, IP address, language preference and information regarding the pages you access. By providing us with this information, you expressly consent to our use of your personal information in accordance with this Policy.
                              </div>
                              ...
                              <div className='pt-7'>
                                  ...
                                  Information we collect about you
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>When you visit our website(s) we may collect information about your IP address, information about your visit, your browsing activity, and how you use our website. This information may be combined with other information you provide.
                              </div>
                              ...
                              <div className='pt-7'>
                                  ...
                                  Information we receive from other sources
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>We may receive information about you if you use any other websites we, or our partners, operate. We also work with third parties (including, contractors, project partners, service providers, analytics providers) and may receive information about you from them. This may be combined with other information you provide to us.
                              </div>
...
We will take the necessary steps to ensure that your privacy rights continue to be protected.
                              ...
                              <div className='pt-7'>
                                  ...
                                  How you can update your information
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>The accuracy of your information is important to us. If you change your email address, or any of the other information we hold is inaccurate or out of date, please email us at marketing@bitsniper.io. You have the right to ask for a copy of the information Bitsniper Kft holds about you.
                              ...
                              <div className='pt-7'>
                                  ...
                                  Profiling
                                    <div className='p-1 bg-lightgreen w-32 mb-8 mt-3'></div></div>
                                  <br/>We may analyse your personal information to create a profile of your preferences and interests so that we can contact you with information relevant to you. We may make use of additional information about you when it is available from external sources to help us do this effectively.
